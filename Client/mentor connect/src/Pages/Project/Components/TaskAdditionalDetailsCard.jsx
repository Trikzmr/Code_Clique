...
const TaskAdditionalDetailsCard = ({ task }) => {
  ...
  const updateTaskStatus = async (newStatus) => {
    setLoading(true);
    try {
      const response = await fetch("https://code-clique-9qgm.vercel.app/api/changetaskstatus", {
        method: "POST",
...
export default TaskAdditionalDetailsCard;
